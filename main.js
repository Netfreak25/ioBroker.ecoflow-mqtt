	...
	onStateChange(id, state) {
		if (state) {
			...
			if ( id = "mqtt.0.app.device.property.DAEBZ5ZD9180661") {
				...
				var json = state.val
				var i_list = this.subsequenceFromStartFromEnd(JSON.stringify(this.jsonata.jsonataExpression((function () {try {return JSON.parse(json);} catch(e) {return {};}})(),'$.params')), 1, 1).split(',');
